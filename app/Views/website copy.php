            ...
            <section id="carousel" class="carousel-section">
                <div id="dynamicCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <?php if (!empty($carousals)): ?>
                            <?php foreach ($carousals as $index => $item): ?>
                                <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                                    <img src="<?= base_url('uploads/' . $item['image']) ?>" class="d-block w-100"
                                        alt="Carousel Image">
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="text-center">No carousel images available.</p>
                        <?php endif; ?>
                    </div>
